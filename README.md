...
To learn more about the software and/or download the compiled version please visit the [Lab Website](https://sites.google.com/view/srivastava-lab/software).  
...
Using the GUI
-------
Detailed descriptions of the features along with instructions for data loading, parameter adjustment, analysis, algorithms comparison, and exporting is provided in the attached manual _DLS GUI Manual.pdf_.  
